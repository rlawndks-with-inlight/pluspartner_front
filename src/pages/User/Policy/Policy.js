            ...
            <Wrappers>
                ...
                {params.pk == 0 ?
                    <>
                        ...
                        <Text>
                            이 약관은 “회사명“ (이하 회사라 칭함)가 제공하는 모든 서비스(이하 서비스라 칭함)의 이용조건 및 절차, 기타 필요한 사항을 규정함을 목적으로 합니다.
                        </Text>
                ...
                {params.pk == 2 ?
                    <>
                        <Text>
                            ...
                            플러스파트너에서 발행되는 모든 콘텐츠는 저작권법에 의하여 보호받는 저작물로서 저작권은 ㈜회사명에 있습니다.<br /><br />

                            플러스파트너(㈜회사명)의 허락 없이 콘텐츠에 대한 무단 복제 및 배포 등 저작권을 침해하는 행위를 금합니다.<br /><br />

                            플러스파트너(㈜회사명)에서 발행하는 모든 콘텐츠를 무단으로 상업적으로 이용하거나 기타 영리 목적으로 이용할 경우 민법상 부당이득, 불법행위 등을 이유로 손해배상 책임을 질 수 있습니다.<br />
                            상업적 또는 기타 영리 목적 등으로 이용을 원할 경우 사전에 플러스파트너(㈜회사명)와 별도 협의를 하거나 허락을 얻어야 하며, 협의 또는 허락을 얻어 자료의 내용을 게재하는 경우에도 출처가 플러스파트너(㈜회사명)임을 반드시 밝혀야 합니다.<br /><br />

                            플러스파트너(㈜회사명)에서 발행하는 모든 콘텐츠를 블로그, SNS, 개인용, 비상업용 등 공익, 비영리 목적에 이용할 경우에도 출처를 플러스파트너(㈜회사명)로 명시하여야 합니다.<br /><br />

                            플러스파트너(㈜회사명)의 콘텐츠를 적법한 절차에 따라 다른 인터넷 사이트에 게재하는 경우에도 내용의 무단 변경을 금지하며, 이를 위반할 때에는 형사처벌을 받을 수 있습니다.<br /><br />
